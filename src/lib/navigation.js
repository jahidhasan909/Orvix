    ...
    items: [
      {
        ...
        children: [
          { id: "inventory", label: "Current Stock", href: "/inventory", module: MODULES.INVENTORY, roles: R.NGO_WORKER, permissions: [PERMISSIONS.INVENTORY_VIEW], designations: [DESIGNATIONS.STORE_LOGISTICS_OFFICER] },
...
export const PAGE_META = {
  ...
  "/inventory": { title: "Current Stock", eyebrow: "Inventory", description: "On-hand stock by warehouse and SKU." },
